...
parser = argparse.ArgumentParser(
    ...
    epilog="Happy Patching",
    usage="cve_prioritizer.py -c CVE-XXXX-XXXX",
)
parser.add_argument(
    "-c", "--cve", type=str, help="Unique CVE-ID", required=False, metavar=""
)
parser.add_argument(
    "-d",
    "--demo",
    help="Top 10 CVEs of the last 7days from cvetrends.com",
    action="store_true",
)
parser.add_argument(
    "-e",
    "--epss",
    type=float,
    help="EPSS threshold (Default 0.2)",
    default=0.2,
    metavar="",
)
parser.add_argument(
    ...
    help="TXT file with CVEs (One per Line)",
    required=False,
    metavar="",
)
parser.add_argument(
    ...
    "--cvss",
    type=float,
    help="CVSS threshold (Default 6.0)",
    default=6.0,
    metavar="",
)
parser.add_argument(
    "-o", "--output", type=str, help="Output filename", required=False, metavar=""
)
parser.add_argument(
    "-t",
    "--threads",
...
parser.add_argument(
    "-l",
    "--list",
    help="Space separated list of CVEs",
    nargs="+",
    required=False,
    metavar="",
)
